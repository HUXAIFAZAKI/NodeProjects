...
while (isRunning) {
  ...
  let currencyDesired:string = answer.convertTo
  if (currencyDesired === "US Dollars") {
    console.log(
      "The amount in US Dollars is:" + answer.amount * 0.0036 + " Dollars"
    );
  } else if (currencyDesired === "Pounds") {
    console.log(
      "The amount in Pounds is:" + answer.amount * 0.0029 + " Pounds"
    );
    ...
    console.log(
      "The amount in UAE Dirhams is:" + answer.amount * 0.013 + " Dirhams");
  }
  else if (currencyDesired === "Japanese Yen") {
    console.log(
      "The amount in Japanese Yen is:" + answer.amount * 0.54 + " Yen");
  }
...
if (exit.option == "Exit") {
    let sureExit = await inquirer.prompt
    (
        [
            {
                type: "list",
