...
const signup = await inquirer_1.default.prompt([
    {
        name: "username",
        type: "string",
...
const signin = await inquirer_1.default.prompt([
    {
        name: "username",
        type: "string",
...
let isRunning = false;
if (signin.username === regUser.userName ||
...
while (isRunning !== false) {
    let ATM = await inquirer_1.default.prompt([
        {
            type: "list",
            name: "choice",
    ...
    if (ATM.choice === "Check Balance") {
        ...
        const drawAmount = await inquirer_1.default.prompt([
            {
                name: "amount",
                type: "number",
        ...
        const addAmount = await inquirer_1.default.prompt([
            {
                name: "amount",
                type: "number",
