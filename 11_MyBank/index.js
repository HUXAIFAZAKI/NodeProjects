...
class BankAccount {
    ...
    mobileNumber;
    accountNumber;
    constructor(balance, firstName, lastName, gender, age, mobileNumber, accountNumber) {
...
async function createAccount() {
    ...
    return new BankAccount(Balance.balance, accountInfo.firstName, accountInfo.lastName, accountInfo.gender, accountInfo.age, accountInfo.mobileNumber, accountInfo.accountNumber);
}
let account = await createAccount();
let isRunning = true;
console.log("+++++++++++++++++++");
console.log("You successfully created your account.\nWhat would you like to do ?");
console.log("+++++++++++++++++++");
while (isRunning) {
    ...
    if (answer.action == "Credit") {
        ...
        account.debit(debit.creditAmount);
    }
